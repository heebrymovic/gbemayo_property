                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <td class="d-flex align-items-center">
                                            <a href="#"><img class="img-fluid rounded" style="max-width: 80px;" src="<?php echo $images[0] ?>" alt="property img"></a>
                                            <div class="ml-3">
                                        ...
                                        <td>
                                            <a class="btn btn-secondary" href="property-detail?property_id=<?php echo base64_encode($property_id) ?>">View More</a>
                                             ...
                                             <a class="btn btn-default" href="commission-details?property_id=<?php echo base64_encode($property_id) ?>">Set Commission</a>
                                             <?php
                                                if ($session_logged_company_privilege_id == 1) {
                                                ?>

                                                    <a href="business-commission-list?property_id=<?php echo base64_encode($property_id) ?>" class="btn btn-info">Business Commissions</a>

                                                    <a href="delete-property?property_id=<?php echo base64_encode($property_id) ?>" class="btn btn-danger">Delete</a>
