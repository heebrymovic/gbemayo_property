                            ...
                            <div id="propertyImgSlider" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    ?>
                                            ...
                                            <img src="<?php echo $value ?>"  style="max-height: 400px; width: 100%;object-fit: cover;" class="img-fluid" alt="">
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            ?>
                            <input  type="text" style="display: none;" id="copyInput" value='<?php echo get_url("/CD/gbemayo/property"). "?refid=" . $fetch_company_info["company_referral_id"] ?>&property-id=<?php echo $fetch_property['property_uniq_id'] ?>'>
